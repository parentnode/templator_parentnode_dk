...
<head>
	...
	<meta name="keywords" content="HTML markup mobile device structure frontend web development" />
...
<? } else { ?>
	<link type="text/css" rel="stylesheet" media="all" href="/css/seg_<?= $this->segment() ?>.css?rev=20230627-094745" />
	<script type="text/javascript" src="/js/seg_<?= $this->segment() ?>.js?rev=20230627-094745"></script>
<? } ?>
